  ...
  <div>
    ...
    <el-table :data="tableData" border stripe style="width: 100%">
      ...
      <el-table-column label="价格(¥)" prop="price" />
       <el-table-column label="类别" prop="cateId">
        <template #default="scope" >
          <span v-for="index in category">
          <span v-if="scope.row.cateId===index.cateId">
            {{ index.catename }}
          </span>
        </span>
        </template>
    ...
    <div class="demo-pagination-block">
      ...
      <el-dialog v-model="dialogFormVisible" title="添加">
        <el-form :model="form" label-width="120px">
          ...
          <el-form-item prop="cateId" label="类别">
          <!-- <el-radio v-model="form.cateId" label="1" >AK47</el-radio>
          <el-radio v-model="form.cateId" label="2" >USP</el-radio>
          <el-radio v-model="form.cateId" label="3" >glock</el-radio> -->
          <el-radio-group v-for="index in category" v-model="form.cateId">
          <el-radio :label="index.cateId">{{index.catename}}</el-radio>
          </el-radio-group>
        </el-form-item>
