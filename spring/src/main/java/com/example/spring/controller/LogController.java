...
public class LogController {
    ...
    public Result<?> findPage(@RequestParam(defaultValue = "1") Integer pageNum,
        ...
        List<Goods> StorageList = GoodsMapper.selectList(Wrappers.<Goods>lambdaQuery().like(Goods::getName, search).eq(Goods::getStoreId, id));
        ...
        for (int i = 0; i < LogList.size(); i++) {
            ...
            log.setStorageName(GoodsMapper.selectById(log.getStorageId()).getName());
